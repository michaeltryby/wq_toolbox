...
# @Last Modified time: 2020-07-02 16:58:24
...
ax[0,0].plot(Ellsworth_inflow_m, 'k--', linewidth=2)
ax[0,0].plot(Ellsworth_inflow_mC, color='#6CC6D1', linewidth=2)
ax[0,0].set_xticks([])
ax[0,0].set_yticks([0,3,6,9])
ax[0,0].set_yticklabels(["0","3","6","9"], size=12)
ax[0,0].set_ylim(-0.1,9.05)
ax[0,0].set_xlim(0,190080)
ax[0,0].set_ylabel("Inflow (m³/s)", size=12)

ax[1,0].plot(Ellsworth_conc, 'k--', linewidth=2)
ax[1,0].plot(Ellsworth_concC, color='#6CC6D1', linewidth=2)
ax[1,0].set_xticks([])
ax[1,0].set_yticks([0,20,40])
ax[1,0].set_yticklabels(["0","20","40"], size=12)
ax[1,0].set_ylim(-0.1,50)
ax[1,0].set_xlim(0,190080)
ax[1,0].set_ylabel("NO (mg/L)", size=12)

ax[2,0].set_ylabel("DO (mg/L", size=12)
ax[2,0].set_xticks([])
ax[2,0].set_yticks([0,5,10])
ax[2,0].set_yticklabels(["0","5","10"], size=12)
ax[2,0].set_ylim(-0.1,10.5)
ax[2,0].set_xlim(0,190080)

ax[3,0].plot(Ell_flood, color='818282', linewidth=2)
ax[3,0].plot(Ellsworth_depth_m, 'k--', linewidth=2)
ax[3,0].plot(Ellsworth_depth_mC, color='#6CC6D1', linewidth=2)
ax[3,0].set_xticks([])
ax[3,0].set_yticks([0,3,6])
ax[3,0].set_yticklabels(["0","3","6"], size=12)
ax[3,0].set_ylim(-0.1,6.5)
ax[3,0].set_xlim(0,190080)
ax[3,0].set_ylabel("Depth (m)", size=12)

ax[4,0].plot(Ellsworth_valveC, color='#6CC6D1', linewidth=2)
ax[4,0].set_xticks([])
ax[4,0].set_ylabel("Valve Position", size=12)
ax[4,0].set_yticks([0,0.5,1])
ax[4,0].set_yticklabels(["0","0.5","1.0"], size=12)
ax[4,0].set_ylim(-0.1,1.05)
ax[4,0].set_xlim(0,190080)

ax[5,0].plot(Ellsworth_outflow_m, 'k--', linewidth=2)
ax[5,0].plot(Ellsworth_outflow_mC, color='#6CC6D1', linewidth=2)
ax[5,0].set_xticks([])
ax[5,0].set_yticks([0,4,8])
ax[5,0].set_yticklabels(["0","4","8"], size=12)
ax[5,0].set_ylim(-0.1,8.5)
ax[5,0].set_xlim(0,190080)
ax[5,0].set_ylabel("Outflow (m³/s)", size=12)

ax[6,0].plot(Ellsworth_cumload, 'k--', linewidth=2)
ax[6,0].plot(Ellsworth_cumloadC, color='#6CC6D1', linewidth=2)
ax[6,0].set_yticks([0,2,4])
ax[6,0].set_yticklabels(["0","2","4"], size=12)
ax[6,0].set_ylim(-0.1,4)
ax[6,0].set_xlim(0,190080)
ax[6,0].set_xticks([0,34560,69120,103680,138240,172800])
ax[6,0].set_xticklabels(["0","2","4","6","8","10"], size=12)
ax[6,0].set_ylabel("Cum. Load (kg)", size=12)
ax[6,0].set_xlabel("Time (days)", size=12)

ax[0,1].plot(DBasin_inflow_m, "k--", linewidth=2)
ax[0,1].plot(DBasin_inflow_mC, color='#3B4D7A', linewidth=2)
ax[0,1].set_xticks([])
ax[0,1].set_yticks([0,3,6,9])
ax[0,1].set_yticklabels(["0","3","6","9"], size=12)
ax[0,1].set_ylim(-0.1,9.05)
ax[0,1].set_xlim(0,190080)

ax[1,1].plot(DBasin_conc, "k--", linewidth=2)
ax[1,1].plot(DBasin_concC, color='#3B4D7A', linewidth=2)
ax[1,1].set_xticks([])
ax[1,1].set_yticks([0,20,40])
ax[1,1].set_yticklabels(["0","20","40"], size=12)
ax[1,1].set_ylim(-0.1,50)
ax[1,1].set_xlim(0,190080)

ax[2,1].set_xticks([])
ax[2,1].set_yticks([0,5,10])
ax[2,1].set_yticklabels(["0","5","10"], size=12)
ax[2,1].set_ylim(-0.1,10.5)
ax[2,1].set_xlim(0,190080)

ax[3,1].plot(Wt_bypass, color='818282', linewidth=2)
ax[3,1].plot(DBasin_depth_m, "k--", linewidth=2)
ax[3,1].plot(DBasin_depth_mC, color='#3B4D7A', linewidth=2)
ax[3,1].set_xticks([])
ax[3,1].set_yticks([0,1.5,3])
ax[3,1].set_yticklabels(["0","1.5","3"], size=12)
ax[3,1].set_ylim(-0.1,3.25)
ax[3,1].set_xlim(0,190080)

ax[4,1].set_xticks([])
ax[4,1].set_yticks([0,0.5,1])
ax[4,1].set_yticklabels(["0","0.5","1.0"], size=12)
ax[4,1].set_ylim(-0.1,1.05)
ax[4,1].set_xlim(0,190080)

ax[5,1].plot(DBasin_outflow_m, "k--", linewidth=2)
ax[5,1].plot(DBasin_outflow_mC, color='#3B4D7A', linewidth=2)
ax[5,1].set_xticks([])
ax[5,1].set_yticks([0,4,8])
ax[5,1].set_yticklabels(["0","4","8"], size=12)
ax[5,1].set_ylim(-0.1,8.5)
ax[5,1].set_xlim(0,190080)

ax[6,1].plot(DBasin_cumload, "k--", linewidth=2)
ax[6,1].plot(DBasin_cumloadC, color='#3B4D7A', linewidth=2)
ax[6,1].set_yticks([0,2,4])
ax[6,1].set_yticklabels(["0","2","4"], size=12)
ax[6,1].set_ylim(-0.1,4)
ax[6,1].set_xlim(0,190080)
ax[6,1].set_xticks([0,34560,69120,103680,138240,172800])
ax[6,1].set_xticklabels(["0","2","4","6","8","10"], size=12)
ax[6,1].set_xlabel("Time (days)", size=12)

ax[0,2].plot(Wetland_inflow_m, "k--", linewidth=2)
ax[0,2].plot(Wetland_inflow_mC, color='#B08CA1', linewidth=2)
ax[0,2].set_xticks([])
ax[0,2].set_yticks([0,3,6,9])
ax[0,2].set_yticklabels(["0","3","6","9"], size=12)
ax[0,2].set_ylim(-0.1,9.05)
ax[0,2].set_xlim(0,190080)

ax[1,2].plot(Wetland_conc, "k--", linewidth=2)
ax[1,2].plot(Wetland_concC, color='#B08CA1', linewidth=2)
ax[1,2].set_xticks([])
ax[1,2].set_yticks([0,20,40])
ax[1,2].set_yticklabels(["0","20","40"], size=12)
ax[1,2].set_ylim(-0.1,50)
ax[1,2].set_xlim(0,190080)

ax[2,2].plot(Wetland_DO1, linestyle="--", color="#B08CA1", linewidth=2)
ax[2,2].plot(Wetland_DO2, linestyle="--", color="#99798C", linewidth=2)
ax[2,2].plot(Wetland_DO3, linestyle="--", color="#493C44", linewidth=2)
ax[2,2].plot(Wetland_DO1C, color="#B08CA1", linewidth=2)
ax[2,2].plot(Wetland_DO2C, color="#99798C", linewidth=2)
ax[2,2].plot(Wetland_DO3C, color="#493C44", linewidth=2)
ax[2,2].set_xticks([])
ax[2,2].set_yticks([0,5,10])
ax[2,2].set_yticklabels(["0","5","10"], size=12)
ax[2,2].set_ylim(-0.1,10.5)
ax[2,2].set_xlim(0,190080)

ax[3,2].plot(Wt_flood, color='818282', linewidth=2)
ax[3,2].plot(Wetland_depth_m, "k--", linewidth=2)
ax[3,2].plot(Wetland_depth_mC, color='#B08CA1', linewidth=2)
ax[3,2].set_xticks([])
ax[3,2].set_yticks([0,1.5,3])
ax[3,2].set_yticklabels(["0","1.5","3"], size=12)
ax[3,2].set_ylim(-0.1,3.25)
ax[3,2].set_xlim(0,190080)

ax[4,2].plot(Wetland_valveC, color='#B08CA1', linewidth=2)
ax[4,2].set_xticks([])
ax[4,2].set_yticks([0,0.5,1])
ax[4,2].set_yticklabels(["0","0.5","1.0"], size=12)
ax[4,2].set_ylim(-0.1,1.05)
ax[4,2].set_xlim(0,190080)

ax[5,2].plot(Wetland_outflow_m, "k--", linewidth=2)
ax[5,2].plot(Wetland_outflow_mC, color='#B08CA1', linewidth=2)
ax[5,2].set_xticks([])
ax[5,2].set_yticks([0,4,8])
ax[5,2].set_yticklabels(["0","4","8"], size=12)
ax[5,2].set_ylim(-0.1,8.5)
ax[5,2].set_xlim(0,190080)

ax[6,2].plot(Wetland_cumload, "k--", linewidth=2)
ax[6,2].plot(Wetland_cumloadC, color='#B08CA1', linewidth=2)
ax[6,2].set_yticks([0,2,4])
ax[6,2].set_yticklabels(["0","2","4"], size=12)
ax[6,2].set_ylim(-0.1,4)
ax[6,2].set_xlim(0,190080)
ax[6,2].set_xticks([0,34560,69120,103680,138240,172800])
ax[6,2].set_xticklabels(["0","2","4","6","8","10"], size=12)
ax[6,2].set_xlabel("Time (days)", size=12)

ax[0,3].plot(Channel_flow_m, "k--", linewidth=2)
ax[0,3].plot(Channel_flow_mC, color='#695580', linewidth=2)
ax[0,3].set_xticks([])
ax[0,3].set_yticks([0,3,6,9])
ax[0,3].set_yticklabels(["0","3","6","9"], size=12)
ax[0,3].set_ylim(-0.1,9.05)
ax[0,3].set_xlim(0,190080)

ax[1,3].plot(Channel_conc, "k--", linewidth=2)
ax[1,3].plot(Channel_concC, color='#695580', linewidth=2)
ax[1,3].set_xticks([])
ax[1,3].set_yticks([0,20,40])
ax[1,3].set_yticklabels(["0","20","40"], size=12)
ax[1,3].set_ylim(-0.1,50)
ax[1,3].set_xlim(0,190080)

ax[2,3].set_xticks([])
ax[2,3].set_yticks([0,5,10])
ax[2,3].set_yticklabels(["0","5","10"], size=12)
ax[2,3].set_ylim(-0.1,10.5)
ax[2,3].set_xlim(0,190080)

ax[3,3].plot(Channel_depth_m, "k--", linewidth=2)
ax[3,3].plot(Channel_depth_mC, color='#695580', linewidth=2)
ax[3,3].set_xticks([])
ax[3,3].set_yticks([0,1.5,3])
ax[3,3].set_yticklabels(["0","1.5","3"], size=12)
ax[3,3].set_ylim(-0.1,3.25)
ax[3,3].set_xlim(0,190080)

ax[4,3].set_xticks([])
ax[4,3].set_yticks([0,0.5,1])
ax[4,3].set_yticklabels(["0","0.5","1.0"], size=12)
ax[4,3].set_ylim(-0.1,1.05)
ax[4,3].set_xlim(0,190080)

ax[5,3].plot(Channel_flow_m, "k--", linewidth=2)
ax[5,3].plot(Channel_flow_mC, color='#695580', linewidth=2)
ax[5,3].set_xticks([])
ax[5,3].set_yticks([0,4,8])
ax[5,3].set_yticklabels(["0","4","8"], size=12)
ax[5,3].set_ylim(-0.1,8.5)
ax[5,3].set_xlim(0,190080)

ax[6,3].plot(Channel_cumload, "k--", linewidth=2)
ax[6,3].plot(Channel_cumloadC, color='#695580', linewidth=2)
ax[6,3].set_yticks([0,2,4])
ax[6,3].set_yticklabels(["0","2","4"], size=12)
ax[6,3].set_ylim(-0.1,4)
ax[6,3].set_xlim(0,190080)
ax[6,3].set_xticks([0,34560,69120,103680,138240,172800])
ax[6,3].set_xticklabels(["0","2","4","6","8","10"], size=12)
ax[6,3].set_xlabel("Time (days)", size=12)

#fig.savefig('NO.svg', format="svg")
plt.show()
