...
# @Last Modified time: 2020-07-02 16:41:05
...
ax[1,1].set_yticklabels(["0","50","100","150"], size=12)

ax[2,1].plot(DBasin_depth_m, color='#3B4D7A', linewidth=2)
ax[2,1].set_yticks([0,1,2,3])
ax[2,1].set_yticklabels(["0","1","2","3"], size=12)
ax[2,1].set_xticks([])
ax[2,1].set_ylim(0,3)
...
ax[3,1].set_yticklabels(["0","3","6","9"], size=12)
ax[3,1].set_ylim(0,9)
ax[3,1].set_xlim(0,86400)
ax[3,1].set_xticks([0,17280,34560,51840,69120,86400])
ax[3,1].set_xticklabels(["0","1","2","3","4","5"], size=12)
ax[3,1].set_xlabel("Time (days)", size=14)
...
ax[1,2].set_yticklabels(["0","50","100","150"], size=12)
ax[1,2].set_xticks([])
...
ax[2,2].set_yticklabels(["0","1","2","3"], size=12)
ax[2,2].set_xticks([])
ax[2,2].set_ylim(0,3)
...
ax[3,2].set_yticklabels(["0","3","6","9"], size=12)
ax[3,2].set_xticks([0,17280,34560,51840,69120,86400])
ax[3,2].set_xticklabels(["0","1","2","3","4","5"], size=12)
ax[3,2].set_xlabel("Time (days)", size=14)
...
ax[1,3].set_yticklabels(["0","50","100","150"], size=12)
...
ax[2,3].set_yticklabels(["0","1","2","3"], size=12)
ax[2,3].set_xticks([])
...
ax[3,3].set_yticklabels(["0","3","6","9"], size=12)
ax[3,3].set_xticks([0,17280,34560,51840,69120,86400])
ax[3,3].set_xticklabels(["0","1","2","3","4","5"], size=12)
ax[3,3].set_xlabel("Time (days)", size=14)
