...
# @Last Modified time: 2020-06-27 14:49:45
...
ax[0,0].plot(Ellsworth_inflow_m)
ax[0,0].set_xticks([])
...
ax[3,0].plot(Ellsworth_outflow_m)
ax[3,0].set_xticks([])
...
ax[4,0].plot(Ellsworth_cumload)
ax[4,0].set_xticks([17280,34560,51840,69120,86400])
ax[4,0].set_xticklabels(["1","2","3","4","5"])
ax[4,0].set_yticks([0,10,20,30,40])
ax[4,0].set_yticklabels(["0","10","20","30","40"])
ax[4,0].set_ylim(0,40)
ax[4,0].set_xlim(0,86400)
ax[4,0].set_ylabel("Cum. Load (kg)")
ax[4,0].set_xlabel("Time (days)")
ax[0,1].plot(DBasin_inflow_m)
ax[0,1].set_xticks([])
...
ax[1,1].plot(DBasin_conc)
ax[1,1].set_xticks([])
ax[1,1].set_yticks([0,50,100,150])
ax[1,1].set_ylim(0,180)
ax[1,1].set_xlim(0,86400)
ax[1,1].set_yticklabels(["0","50","100","150"])
ax[2,1].plot(DBasin_depth_m)
ax[2,1].set_yticks([0,1,2,3])
ax[2,1].set_yticklabels(["0","1","2","3"])
ax[2,1].set_xticks([])
ax[2,1].set_ylim(0,3)
ax[2,1].set_xlim(0,86400)
ax[3,1].plot(DBasin_outflow_m)
ax[3,1].set_yticks([0,3,6,9])
ax[3,1].set_yticklabels(["0","3","6","9"])
ax[3,1].set_xticks([])
ax[3,1].set_ylim(0,9)
ax[3,1].set_xlim(0,86400)
ax[4,1].plot(DBasin_cumload)
ax[4,1].set_yticks([0,10,20,30,40])
ax[4,1].set_yticklabels(["0","10","20","30","40"])
ax[4,1].set_xticks([17280,34560,51840,69120,86400])
ax[4,1].set_xticklabels(["1","2","3","4","5"])
ax[4,1].set_ylim(0,40)
ax[4,1].set_xlim(0,86400)
ax[4,1].set_xlabel("Time (days)")
ax[0,2].plot(Wetland_inflow_m)
...
ax[1,2].plot(Wetland_conc)
ax[1,2].set_yticks([0,50,100,150])
ax[1,2].set_yticklabels(["0","50","100","150"])
ax[1,2].set_xticks([])
ax[1,2].set_ylim(0,180)
ax[1,2].set_xlim(0,86400)
ax[2,2].plot(Wetland_depth_m)
ax[2,2].set_yticks([0,1,2,3])
ax[2,2].set_yticklabels(["0","1","2","3"])
ax[2,2].set_xticks([])
ax[2,2].set_ylim(0,3)
ax[2,2].set_xlim(0,86400)
ax[3,2].plot(Wetland_outflow_m)
ax[3,2].set_ylim(0,9)
ax[3,2].set_xlim(0,86400)
ax[3,2].set_yticks([0,3,6,9])
ax[3,2].set_yticklabels(["0","3","6","9"])
ax[3,2].set_xticks([])
ax[4,2].plot(Wetland_cumload)
ax[4,2].set_ylim(0,40)
ax[4,2].set_xlim(0,86400)
ax[4,2].set_yticks([0,10,20,30,40])
ax[4,2].set_yticklabels(["0","10","20","30","40"])
ax[4,2].set_xticks([17280,34560,51840,69120,86400])
ax[4,2].set_xticklabels(["1","2","3","4","5"])
ax[4,2].set_xlabel("Time (days)")
ax[0,3].plot(Channel_flow_m)
...
ax[1,3].plot(Channel_conc)
ax[1,3].set_yticks([0,50,100,150])
ax[1,3].set_yticklabels(["0","50","100","150"])
ax[1,3].set_ylim(0,180)
ax[1,3].set_xlim(0,86400)
ax[1,3].set_xticks([])
ax[2,3].plot(Channel_depth_m)
ax[2,3].set_ylim(0,3)
ax[2,3].set_xlim(0,86400)
ax[2,3].set_yticks([0,1,2,3])
ax[2,3].set_yticklabels(["0","1","2","3"])
ax[2,3].set_xticks([])
ax[3,3].plot(Channel_flow_m)
ax[3,3].set_ylim(0,9)
ax[3,3].set_xlim(0,86400)
ax[3,3].set_yticks([0,3,6,9])
ax[3,3].set_yticklabels(["0","3","6","9"])
ax[3,3].set_xticks([])
ax[4,3].plot(Channel_cumload)
ax[4,3].set_ylim(0,40)
ax[4,3].set_xlim(0,86400)
ax[4,3].set_yticks([0,10,20,30,40])
ax[4,3].set_yticklabels(["0","10","20","30","40"])
ax[4,3].set_xticks([17280,34560,51840,69120,86400])
ax[4,3].set_xticklabels(["1","2","3","4","5"])
ax[4,3].set_xlabel("Time (days)")
plt.show()